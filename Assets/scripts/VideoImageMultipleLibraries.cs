...
public class VideoImageMultipleLibraries : MonoBehaviour
{
...
private void Dismiss() => welcomePanel.SetActive(false);
    ...
    void AssignGameObject(string name, Vector3 newPosition)
    {
        if (arObjectsToPlace != null)
        {
            ...
            if (goARObject == arObjects["leonardNimoy"] || arObjects["playitsam"])
            {
                m_TrackedImageManager.trackedImagePrefab = goARObject;
            }
            else
            {
